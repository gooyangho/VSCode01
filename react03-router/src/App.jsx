...
const TopNavi = () =>{
  ...
  return (
    <nav>
      ...
      <a href="/aTg" onClick={(e)=>{e.preventDefault()}}>A태그</a>&nbsp;
      {/* Link 컴포넌트는 NavLink의 기능은 동일하지만, active 속성값이
      부여되지 않는다. */}
...
const RouterHooks = () =>{
  ...
  /* 쿼리스트링에서 파라미터를 얻어온다. 첫 집입시에는 둘다 null이다. 
